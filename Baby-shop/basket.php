	...
	<main class="main-content list-content">
		...
		<section class="basket">
			<div class="basket-header">
				<p class="basket-header__img">Фото</p>
				<p class="basket-header__name">Имя</p>
				<p class="basket-header__price">Цена</p>
				<p class="basket-header__total">Всего</p>
			</div>
			...
			<div class="basket__footer">
				<p class="basket__header-title">Итого:</p>
				<p class="basket__header-price">0</p>
				<p class="basket__header-rub">&#8381</p>
			</div>
			<div class="basket-button__wrapper">
				<button class="basket-button button">Купить</button>
			</div>
		</section>
		<section class="basket__empty done">
			<p>В Вашей корзине пусто :(</p>
		</section>

				<template class="basket-template">
					<div class="basket-item">
						<div class="basket-item__wrapper">
							<img src="#" alt="" class="basket-item__photo-img" width="100%" height="100%">
						</div>
						<div class="basket-item__wrapper">
							<p class="basket-item__name"></p>
						</div>
						<div class="basket-item__wrapper">
							<p class="basket-item__price"></p>
						</div>
						<div class="basket-item__wrapper">
							<p class="basket-item__total"></p>
						</div>
					</div>
						<div class="item__buttons">
							...
							<button class="item-button button">Убрать</button>
						</div>
				</template>
