...
<template class="menu__template">
	...
	<script src="js/render_item.js"></script>
			...
			<template class="item__template">
				<div class="item__product-info">
					...
					<div class="item__prices">
						<p class="item__prices-new"></p>
						<p class="item__prices-old"></p>
						<p class="item__prices-ue">Руб</p>
					</div>
					<div class="product-item__rating">
						...
						<span class="product-item__rating-item"></span>
						<span class="product-item__rating-item"></span>
						<a href="#vk_comments" class="item__prices-count-comment"></a>
					</div>
					<div class="item__manufactured">
						<p class="manufactured__title">Производитель:</p>
						<p class="manufactured__text"></p>
					</div>
					<div class="item__code">
						<p class="code__title">Код товара:</p>
						<p class="code__text"></p>
					</div>
					<div class="item__discription">
						<p class="discription__title">Описание:</p>
						<p class="discription__text"></p>
					</div>
					<div class="item__buttons">
						<div class="add-category__spot">
						<div class="add-category__spot-left"></div>
							<label class="add-category__spot-label">
								<div class="add-category__label-info">1
								</div>
						...
						<button class="item-button button">В корзину</button>
					</div>
				</div>
				<div class="item__galery">
					<div class="galery__main-photo">
						<img src="#" alt="" class="main-pgoto__img" width="100%" height="100%">
					</div>
					<div class="galery__second-photo">
						
					</div>
				</div>
				<div class="item__subscribe">
					<p class="subscribe__title">Подробная информация:</p>
					<p class="subscribe__text"></p>
				</div>
				<div class="vk_comments__wrapper">
					<div id="vk_comments" class="vk_comments"></div>
				</div>
			</template>

			<template class="second-photo__img-template">
				<img src="#" alt="" class="second-photo__img" width="100%" height="100%">
			</template>
